...
if %ERRORLEVEL% == 0 (
    ...
    copy build\fastchunk.dll src\main\resources\native\fastchunk.dll /Y
    copy build\fastchunk.dll src\main\resources\win32-x86-64\fastchunk.dll /Y
    copy build\fastchunk.dll target\classes\native\fastchunk.dll /Y 2>nul
    echo.
